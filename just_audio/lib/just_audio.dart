...
class AudioPlayer {
  ...
  Future<Duration?> load() async {
    ...
    if (_active) {
      ...
      return await _load(platform, _audioSource!, initialSeekValues: initialSeekValues, activationNumber: activationNumber);
    } else {
  ...
  Future<Duration?> _load(AudioPlayerPlatform platform, AudioSource source, {_InitialSeekValues? initialSeekValues, int? activationNumber}) async {
    ...
    if (activationNumber == null) {
      activationNumber = _activationCount;
    } else {
      checkInterruption();
    }
...
class ConcatenatingAudioSource extends AudioSource {
  ...
  Future<void> clear() async {
    ...
    if (_player != null) {
      _player!._broadcastSequence();
      await (await _player!._platform)
          .concatenatingRemoveRange(ConcatenatingRemoveRangeRequest(id: _id, startIndex: 0, endIndex: end, shuffleOrder: List.of(_shuffleOrder.indices)));
    }
  }
